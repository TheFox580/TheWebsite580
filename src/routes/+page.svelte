<script lang="ts">
    ...
    import EightyEightByThirtyOne from "$lib/components/other/EightyEightByThirtyOne.svelte"
...
<div class="flex flex-col justify-center items-center my-10 text-2xl">
    <div class="w-8/10 text-center">
